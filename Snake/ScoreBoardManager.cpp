...
{
	mDefaultColors.push_back(CONSOLE_COLOR::GREEN);
	mDefaultColors.push_back(CONSOLE_COLOR::SKY);
	mDefaultColors.push_back(CONSOLE_COLOR::RED);
	mDefaultColors.push_back(CONSOLE_COLOR::PINK);
	mDefaultColors.push_back(CONSOLE_COLOR::YELLOW);
	mDefaultColors.push_back(CONSOLE_COLOR::WHITE);
}

ScoreBoardManager::Entry::Entry(uint32_t inPlayerId, const string& inPlayerName, const CONSOLE_COLOR& inColor) :
